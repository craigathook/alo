function AnimationLoader(){
  ...
  this.animationLoaded = function(e){
    ...
    window.lib = null;
    //window.images = null; // this *isn't* done because a referemce to global images variable is passed into the createjs closure. nullifying this variable breaks that reference.
    window.ss = null;
