...
(lib.mc_over = function() {
	...
	this.shape.graphics.f("#0099FF").s().p("");
...
(lib.mc_a = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0099FF").s().p("AqfKgQkXkWAAmKQAAmJEXkWQEWkXGJAAQGKAAEWEXQEXEWAAGJQAAGKkXEWQkWEXmKAAQmJAAkWkXgApspsQkBECAAFqQAAFrEBECQECEBFqAAQFrAAECkBQEBkCAAlrQAAlqkBkCQkCkBlrAAIAAAAQlqAAkCEBgADdFtIg7i1Ik+AAIg/C1IiDAAIFctkIAeAAIFDNkgAh8BiID9AAIh7l4g");
	this.shape.setTransform(91.5,91.5);
